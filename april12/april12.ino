...
void loop()                   
{
  ...
  float touch1 =  cs_12_3.capacitiveSensor(1000);
  float touch2 =  cs_12_4.capacitiveSensor(1000);
  float touch3 =  cs_12_5.capacitiveSensor(1000);
  float touch4 =  cs_12_6.capacitiveSensor(1000);
  float touch5 =  cs_12_7.capacitiveSensor(1000);
  float touch6 =  cs_12_8.capacitiveSensor(1000);
  float touch7 =  cs_12_9.capacitiveSensor(1000);
  float touch8 =  cs_12_10.capacitiveSensor(1000);
